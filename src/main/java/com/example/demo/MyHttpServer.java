...
public class MyHttpServer {
    ...
    static class EntryHandler implements HttpHandler {
        private final All_workers workers_data;
        ...
        public void handle(HttpExchange exchange) throws IOException {
            ...
            if ("GET".equals(requestMethod)) {
                ...
                String idStr = queryString.replace("id=", "");
    ...
    static class ExitHandler implements HttpHandler {
        ...
        public void handle(HttpExchange exchange) throws IOException {
            ...
            String requestMethod = exchange.getRequestMethod();
            if ("GET".equals(requestMethod)) {String queryString = exchange.getRequestURI().getQuery();
                if (queryString == null || !queryString.contains("id=")) {
                    exchange.sendResponseHeaders(500, -1);
                    OutputStream os = exchange.getResponseBody();
                    String response = "";
